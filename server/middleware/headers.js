module.exports = (req, res, next) => {
    ...
    res.header("access-control-allow-headers", "Origin, X-Requested-Width, Content-Type, Accept, Authorization" // which headers can be used when making a request to the server
    );
    next();
};
